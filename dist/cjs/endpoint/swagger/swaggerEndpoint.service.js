...
class SwaggerEndPoint extends endPoint_abstract_1.AbstractEndPoint {
    ...
    sendRequest(routeName, parameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requestResult = yield sendHttp_util_1.SendHttpRequestUtil.sendEndPointRequest(route, this.endPoint, parameters);
            try {
                return yield requestResult.json();
            }
            catch (error) {
                return yield requestResult.text();
            }
        });
    }
    generate() {
