        ...
        for (const [key, definition] of Object.entries(securityDefinitions)) {
            ...
            switch (definition.type) {
                case 'http':
                    ...
                    break;
                case 'apiKey':
                    securityEntity = new KeyAuthEntity('apiKey', definition.type, definition.in, definition.name, false);
                    break;
                case 'oauth2':
                    securityEntity = new CustomAuthEntity('oauth2', definition.flows?.authorizationCode);
                    break;
                default:
